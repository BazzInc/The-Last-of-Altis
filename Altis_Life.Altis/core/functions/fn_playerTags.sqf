		...
		if(count _sPos > 1 && {_distance < 15}) then {
			_text = switch (true) do {
				...
				case (!isNil {(_x getVariable "rank")}): {format["<img image='%1' size='1'></img> %2",switch ((_x getVariable "rank")) do {
					case 2: {"core\icon\obermeister.paa"}; 
					case 3: {"core\icon\hauptmeister.paa"};
					case 4: {"core\icon\kommisar.paa"};
					case 5: {"core\icon\oberkommisar.paa"};
					case 6: {"core\icon\hauptkommisar.paa"};
					case 7: {"core\icon\sek.paa"};
					case 8: {"core\icon\rat.paa"};
					case 9: {"core\icon\direktor.paa"};
					default {"core\icon\meister.paa"};
