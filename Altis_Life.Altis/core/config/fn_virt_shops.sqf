...
switch (_shop) do
{
	...
	case "cop": {["Cop Item Shop",["donuts","coffee","redgull","spikeStrip","mauer","battery","painkillers","redgull","defusekit"​,"gpstracker"]]};
	case "cement": {["Cement Dealer",["cement"]]};
	case "beer": {["Schnaps Laden",["wine"]]};
	case "pharmacy": {["Apotheke",["painkillers","morphium","scalpel","kidney","redgull"]]};
