...
switch(_shop) do
{
	...
	case "cop_patrol":
	{
		...
		{
			case (playerSide !=west): {"Du bist kein Polizist"};
			case (__GETC__(life_coplevel) < 1): {"Du bist noch kein Polizei Meister !"};
			default
			{
	...
	case "cop_obermeister":
	{
		switch(true) do
		{
			case (playerSide !=west): {"Du bist kein Polizist"};
			case (__GETC__(life_coplevel) < 2): {"Du bist noch kein Polizei Obermeister"};
			default
			{
				["Polizei Obermeister Waffen Shop",
					[
	...
	case "cop_hauptmeister":
	{
		switch(true) do
		{
			case (playerSide !=west): {"Du bist kein Polizist"};
			case (__GETC__(life_coplevel) < 3): {"Du bist kein Hauptmeister"};
			default
			{
				["Hauptmeister Waffen Shop",
					[
						["SMG_02_F",nil,10],
						["arifle_MX_Black_F",nil,10],
						["arifle_MXC_Black_F",nil,10],
	...
	case "cop_kommisar":
	{
		...
		{
			case (playerSide !=west): {"Du bist kein Polizist"};
			case (__GETC__(life_coplevel) < 4): {"Du bist kein Kommisar"};
			default
			{
				["Kommisar Shop",
					[
	...
	case "cop_oberkommisar":
	{
		switch(true) do
		{
			case (playerSide !=west): {"Du bist kein Polizist"};
			case (__GETC__(life_coplevel) < 5): {"Du bist nicht Oberkommisar"};
			default
			{
				["Oberkommisar Waffen Shop",
					[
						["arifle_MXM_Black_F",nil,10],
						["arifle_MX_Black_F",nil,10],
						["arifle_MXC_Black_F",nil,10],
						["arifle_MX_SW_Black_F",nil,10],
						["arifle_MX_GL_Black_F",nil,1500],
	...
	case "cop_haupt":
	{
		...
		{
			case (playerSide !=west): {"Du bist kein Polizist"};
			case (__GETC__(life_coplevel) < 6): {"Du bist nicht Hauptkommisar"};
			default
			{
	...
	case "cop_rat":
	{
		...
		{
			case (playerSide !=west): {"Du bist kein Polizist"};
			case (__GETC__(life_coplevel) < 7): {"Du bist nicht Polizei Rat"};
			default
			{
				["Hauptkommisar Waffen Shop",
					[
	...
	case "cop_sek":
	{
		...
		{
			case (playerSide !=west): {"Du bist kein Polizist"};
			case (__GETC__(life_coplevel) < 8): {"Du bist nicht in der SEK"};
			default
			{
				["SEK Waffen Shop",
					[
	...
	case "cop_direktor":
	{
		...
		{
			case (playerSide !=west): {"Du bist kein Polizist"};
			case (__GETC__(life_coplevel) < 9): {"Du bist nicht der Direktor"};
			default
			{
				["SEK Waffen Shop",
					[
	...
	case "donator":
	{
		switch(true) do
		{
			case (__GETC__(life_donator) == 0): {"Du hast noch nicht donatet!"};
