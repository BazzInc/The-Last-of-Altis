class agb
{
    ...
    class controlsBackground
    {
        ...
        class RsclolStatus : Life_RscStructuredText
        {
            ...
            colorBackground[] = {0, 0, 0, 0};
            sizeEx = 0.0001;
            text = "<t size = '0.8'>Unerwuenschtes Fehlverhalten fuert ggf. zu Bann<br / >ß1: Hacking / Cheating / Duping / Belleidigungen<br / >ß1.1: Selbstmord / Disconnect um sich dem Rollenspiel zu entziehen.<br / >ß1.2: Bugs/Exploites ausnutzen - im Zweifel Admin fragen<br / ><br / >ß2:RP wird bei uns Groﬂ geschrieben. H‰llst du dich nicht an das RP, hast du hier nix verloren!<br / ><br / >ß3: RDM / VDM wird sofort geahndet und die T‰ter gebannt.<br / ><br / >Unsere Kontaktdaten: <br / >TS≥ ts08.nitrado.net:13350<br / >Homepage Kommt Bald<br / >Admins: <br / >Aquaman<br / > SharkEyes <br / >Helmut Dieter Juergens<br / > <br / ><br / >Hinweis: Wir suchen ADAC/Medics und Polizisten. Bewerbungen im TS.<br / ></t> <t font ='PuristaBold' size='0.9'>Um auf dem The Last of Altis Server zu spielen musst du diesen Regeln zustimmen und verpflichtest dich dazu diese einzuhalten.</t>";
            x = 0.1125;
            y = 0.16;
            w = 0.775;
            h = 0.66;
