...
*/
private["_side","_return","_reank"];
_side = [_this,0,civilian,[civilian]] call BIS_fnc_param;
_rank = player getVariable "rank";
...
switch (_side) do
{
	case west:
	{
		_return = [
			...
			["cop_spawn_gsg9","SEK","\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa"]
		];
	};
	...
	{
		_return = [
			["adac_spawn_1","ADAC Kavala","\a3\ui_f\data\map\Markers\NATO\b_air.paa"],
			["adac_spawn_2","ADAC Ost","\a3\ui_f\data\map\Markers\NATO\b_air.paa"],
			["adac_spawn_3","ADAC Pygros","\a3\ui_f\data\map\Markers\NATO\b_air.paa"]
		];
	};
};
