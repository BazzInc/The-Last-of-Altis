class jail_time
{
	...
	class controls 
	{
		class Title : Life_RscTitle {
			colorBackground[] = {0.85,0.0000000001,0.0001,1};//colorBackground[] = {0, 0, 0, 0};
			idc = 2651;
		...
		class payTicket: Life_RscButtonMenu {
			idc = 2402;
			text = "Absenden";
			colorBackground[] = {0.85,0.0000000001,0.0001,1};//colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
