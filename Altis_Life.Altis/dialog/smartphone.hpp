class Life_my_smartphone {
	...
	class controlsBackground {
		class Life_RscTitleBackground:Life_RscText {
			colorBackground[] = {0.85,0.0000000001,0.0001,1};//colorBackground[] = {0.85,0.0000000001,0.0001,1};//colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", "(profilenamespace getvariable ['GUI_BCG_RGB_A',0.7])"};
			idc = -1;
			x = 0.1;
			y = 0.2;
			w = 0.95;
    ...
    class PlayerListTitleBackground:Life_RscText {
			colorBackground[] = {0.85,0.0000000001,0.0001,1};//colorBackground[] = {0.588, 0.424, 0.145, 1.0};
			idc = -1;
			x = 0.11;
			y = 0.25;
			w = 0.2;
	...
	class controls {
		...
		class TextShow : Life_RscControlsGroup {
			...
			class controls {
				class showText : Life_RscStructuredText {
					idc = 88887;
					text = "";
					colorBackground[] = {0.85,0.0000000001,0.0001,1};//colorBackground[] = {0.28,0.28,0.28,0.28};
		...
		class Schreiben : Life_RscButtonMenu {
			...
			colorBackground[] = {0.85,0.0000000001,0.0001,1};//colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 1.0};
			x = 0.11;
			y = 0.25 + (1 / 25) + 0.51;
			w = 0.2;
			h = (1 / 25);
		...
		class Notruf : Life_RscButtonMenu {
			...
			colorBackground[] = {0.85,0.0000000001,0.0001,1};//colorBackground[] = {0.584, 0.086, 0.086,1.0};
			x = 0.325 + 0.7 - (6.25 / 40);
			y = 0.25 + (1 / 25) + 0.51;
			w = (6.25 / 40);
			h = (1 / 25);
