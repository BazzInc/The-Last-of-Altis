...
switch (_type) do
{
	...
	case "pilot": {85000}; //Pilot/air license cost
	case "gun": {125000}; //Firearm/gun license cost
	case "dive": {10000}; //Diving license cost
