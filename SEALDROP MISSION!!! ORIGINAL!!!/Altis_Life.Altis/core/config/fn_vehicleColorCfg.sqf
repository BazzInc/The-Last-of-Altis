...
switch (_vehicle) do
{
	...
	case "B_MRAP_01_F":
	{
		...
		_ret = 
		[
			[_path + "hunter_sek_front1.paa","cop",_path + "hunter_sek_hinten1.paa"],
	...
	case "O_MRAP_02_F":
	{
		...
		[
			...
			[_path + "notarzt_ifrit_teil1.paa","civ",_path + "notarzt_ifrit_teil2.paa","med"]
		];
	};
